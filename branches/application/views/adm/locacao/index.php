...
<div class="row col-lg-12">
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            ...
            <?php
            $this->table->set_heading('Id', 'Cliente', 'Modelo', 'Placa ', 'Funcionario', 'Valor', 'Data incio', 'Data fim', 'Status', 'Ações');
            ...
            foreach ($locacao as $l) {
                ...
                $link_editar = base_url($this->config->item('area_admin') . '/cliente/editar/' . $l->id);
                ...
                $this->table->add_row(
                        $l->id, $l->nome_cli, $l->modelo, $l->placa, $l->funcionario,$l->valor_total,$l->data_ini,$l->data_fim,$status_locacao, $acoes
                );
            }
