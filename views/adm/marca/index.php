...
<div class="row col-lg-12">
    <div class="panel panel-default">
        <div class="panel-heading">
            <a class="btn btn-primary" href="<?php echo base_url($this->config->item('area_admin') . '/marca/cadastrar'); ?>">Cadastrar</a>
        </div> 
        <div class="panel-body">
            ...
            foreach ($marca as $g) {
                ...
                $link_editar  = base_url($this->config->item('area_admin') . '/marca/editar/' . $g->id);
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabel">Remover marca de veiculo</h4>
            </div>
            <div class="modal-body">
                <p>Você realmente deseja remover este marca de veiculo?</p>
            </div>
            <div class="modal-footer">
                <a href="#" class="btn btn-default" data-dismiss="modal">Não</a>
                <a href="<?php echo base_url($this->config->item('area_admin') . '/marca/remover/'); ?>" id="confirma_remocao" class="btn btn-primary">Sim</a>
            </div>
        </div>
    </div>
</div>