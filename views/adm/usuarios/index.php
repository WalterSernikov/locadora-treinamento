...
<div class="row col-lg-12">
    <div class="panel panel-default">
        <div class="panel-heading">
            <a class="btn btn-primary" href="<?php echo base_url($this->config->item('area_admin') . '/usuarios/cadastrar'); ?>">Cadastrar</a>
        </div> 
        <div class="panel-body">
            ...
            foreach ($usuarios as $u) {
                ...
                $link_editar  = base_url($this->config->item('area_admin') . '/usuarios/editar/' . $u->id);
